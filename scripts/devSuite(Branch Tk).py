...
window.title("Dev Suite Tools")

window.geometry('720x480')

lbl = Label(window, text="Hello", font=("New Romans", 16))
...
def clicked():
    def argvAll():
        ...
        def installAll():
            ...
            argvAll()
            lbl.configure(text="OK It RUN!!")

btn = Button(window, text="Install All", command=clicked)
